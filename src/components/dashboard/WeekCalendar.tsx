...
export function WeekCalendar() {
  ...
  function prevWeek() { setWeekStart((d) => subWeeks(d, 1)) }
  function nextWeek() { setWeekStart((d) => addWeeks(d, 1)) }
  function goToday() {
          ...
          return (
            <div key={dateStr} className="flex flex-col gap-1">
              ...
              >
                ...
                <span className={cn('text-lg font-bold leading-tight', todayFlag && !isSelected && 'text-indigo-600')}>
                  {format(day, 'd')}
                </span>
              </button>
