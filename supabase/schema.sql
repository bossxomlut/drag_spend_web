...
BEGIN
  INSERT INTO categories (user_id, name, icon, color, type) VALUES
    ...
    (p_user_id, 'Di chuyển',     '🚗', '#3b82f6', 'expense'),
    (p_user_id, 'Mua sắm',       '🛍️', '#ec4899', 'expense'),
    (p_user_id, 'Giải trí',      '🎮', '#8b5cf6', 'expense'),
    (p_user_id, 'Y tế',          '💊', '#ef4444', 'expense'),
    (p_user_id, 'Hóa đơn',       '💡', '#f97316', 'expense'),
    (p_user_id, 'Lương',         '💰', '#10b981', 'income'),
    (p_user_id, 'Thưởng',        '🎁', '#06b6d4', 'income'),
    (p_user_id, 'Đầu tư',        '📈', '#84cc16', 'income'),
