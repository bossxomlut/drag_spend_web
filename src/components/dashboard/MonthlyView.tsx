      ...
      <div className="px-4 pt-5 pb-4 border-b border-slate-100">
        <div className="flex items-center justify-between mb-4">
          <Button
            ...
            onClick={() => setViewMonth(format(subMonths(firstOfMonth, 1), 'yyyy-MM'))}
          >
          ...
          <Button
            ...
            size="sm"
            className="h-8 w-8 p-0"
            onClick={() => setViewMonth(format(addMonths(firstOfMonth, 1), 'yyyy-MM'))}
          >
        ...
        <div className="grid grid-cols-7 gap-y-0.5">
          {days.map((day) => {
            ...
            return (
              ...
              >
                <span className={cn('font-medium leading-none', isSelected && 'text-white')}>
                  {format(day, 'd')}
                </span>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between p-3 rounded-xl bg-green-50 border border-green-100">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-green-700 font-medium">Thu nhập</span>
            </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <span className={cn(
              'text-sm font-bold',
              monthNet > 0 ? 'text-green-600' : monthNet < 0 ? 'text-red-500' : 'text-slate-500'
            )}>
              {monthNet > 0 ? '+' : ''}{formatCompact(monthNet)}
            </span>
          </div>
        </div>
